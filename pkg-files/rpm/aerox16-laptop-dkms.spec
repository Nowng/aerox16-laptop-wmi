...
%description
This package contains the DKMS aerox16-laptop kernel module.
...
%post
dkms add -m aerox16-laptop -v %{version}
dkms install --force -m aerox16-laptop -v %{version}

%preun
dkms remove -m aerox16-laptop -v %{version} --all
