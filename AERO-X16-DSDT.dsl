 ...
 *
 * Disassembly of OEM/DSDT.aml
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A517 (42263)
 *     Revision         0x02
 *     Checksum         0xE6
 *     OEM ID           "GBT   "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "GBT   ", "GBTUACPI", 0x01072009)
{
    ...
    External (_SB_.MHUR, FieldUnitObj)
    External (_SB_.MMIN, FieldUnitObj)
    ...
    External (_SB_.PCI0.AMW0.ECPL, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.AMW0.WXCM, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GFX0.CLID, UnknownObj)
    External (_SB_.PCI0.GFX0.VGA_.LCD_, DeviceObj)
    External (_SB_.PCI0.GPP9, DeviceObj)
    External (_SB_.PCI0.GPP9.D0ST, IntObj)
    External (_SB_.PCI0.GPP9.PEGP, UnknownObj)
    External (_SB_.PCI0.GPP9.PEGP._ON_, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GPP9.PEGP.NLIM, IntObj)
    External (_SB_.PCI0.GPP9.PG00._OFF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GPP9.WMOF, IntObj)
    External (_SB_.PCI0.GPPA.VGA_.LCD_, DeviceObj)
    External (_SB_.PCI0.SBRG.EC0_.CTUR, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.ERCD, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.ESMB, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.ESMS, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.OSTE, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.OSTH, FieldUnitObj)
    External (_SB_.PCI0.SBRG.EC0_.OSTM, FieldUnitObj)
    External (_SB_.PCI0.SBRG.OSYS, UnknownObj)
    External (_SB_.U4PC, IntObj)
    External (_SB_.UCEV, MethodObj)    // 0 Arguments
    External (AFN4, MethodObj)    // 1 Arguments
    External (AFN7, MethodObj)    // 1 Arguments
    External (CRBI, UnknownObj)
    External (DPMF, FieldUnitObj)
                ...
                Device (XHC1)
                {
                    ...
                    Device (RHUB)
                    {
                        ...
                        Device (PRT1)
                        {
                            ...
                            {
                                Return (UPCC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.UPCC */
                            }

                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                Return (PLDC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.PLDC */
                            }
                            ...
                            Device (CAM0)
                            {
                                ...
                                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                                {
                                    Return (UPCC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.CAM0.UPCC */
                                }

                                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                                {
                                    Return (PLDC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.CAM0.PLDC */
                                }
                            }
                            ...
                            Device (CAM1)
                            {
                                ...
                                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                                {
                                    Return (UPCC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.CAM1.UPCC */
                                }

                                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                                {
                                    Return (PLDC) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT1.CAM1.PLDC */
                                }
                            }
                        }
                        ...
                        Device (PRT2)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                Return (UPCN) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT2.UPCN */
                            }

                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                Return (PLDN) /* \_SB_.PCI0.GPPA.XHC1.RHUB.PRT2.PLDN */
                            }
                        }
                    }
                }
                    ...
                    Device (RHUB)
                    {
                        ...
                        Device (PRT4)
                        {
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (M601 (0x02, Zero, 0x08, Zero, 0x0112, Zero))
                            }
                        }
                        ...
                        Device (PRT7)
                        {
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLD0) /* \_SB_.PCI0.GPPC.XHC0.RHUB.PRT7.PLD0 */
                            }
                        }
                    }
                }
    ...
    Scope (_SB)
    {
        ...
        OperationRegion (CMM0, SystemMemory, 0xFED80700, 0x06)
    ...
    Scope (_SB.PCI0)
    {
        Device (UAR1)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (BUF0, \_SB.PCI0.UAR1._CRS._Y21._MIN, IOLO)  // _MIN: Minimum Base Address
                CreateByteField (BUF0, 0x03, IOHI)
                CreateByteField (BUF0, \_SB.PCI0.UAR1._CRS._Y21._MAX, IORL)  // _MAX: Maximum Base Address
                CreateByteField (BUF0, 0x05, IORH)
                CreateWordField (BUF0, \_SB.PCI0.UAR1._CRS._Y22._INT, IRQL)  // _INT: Interrupts
                Local0 = FUIO (Zero)
        ...
        Device (UAR2)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (BUF0, \_SB.PCI0.UAR2._CRS._Y23._MIN, IOLO)  // _MIN: Minimum Base Address
                CreateByteField (BUF0, 0x03, IOHI)
                CreateByteField (BUF0, \_SB.PCI0.UAR2._CRS._Y23._MAX, IORL)  // _MAX: Maximum Base Address
                CreateByteField (BUF0, 0x05, IORH)
                CreateWordField (BUF0, \_SB.PCI0.UAR2._CRS._Y24._INT, IRQL)  // _INT: Interrupts
                Local0 = FUIO (One)
                Switch (ToInteger (Local0))
                {
                    Case (Zero)
        ...
        Device (UAR3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (BUF0, \_SB.PCI0.UAR3._CRS._Y25._MIN, IOLO)  // _MIN: Minimum Base Address
                CreateByteField (BUF0, 0x03, IOHI)
                CreateByteField (BUF0, \_SB.PCI0.UAR3._CRS._Y25._MAX, IORL)  // _MAX: Maximum Base Address
                CreateByteField (BUF0, 0x05, IORH)
                CreateWordField (BUF0, \_SB.PCI0.UAR3._CRS._Y26._INT, IRQL)  // _INT: Interrupts
                Local0 = FUIO (0x02)
                Switch (ToInteger (Local0))
                {
                    Case (Zero)
        ...
        Device (UAR4)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (BUF0, \_SB.PCI0.UAR4._CRS._Y27._MIN, IOLO)  // _MIN: Minimum Base Address
                CreateByteField (BUF0, 0x03, IOHI)
                CreateByteField (BUF0, \_SB.PCI0.UAR4._CRS._Y27._MAX, IORL)  // _MAX: Maximum Base Address
                CreateByteField (BUF0, 0x05, IORH)
                CreateWordField (BUF0, \_SB.PCI0.UAR4._CRS._Y28._INT, IRQL)  // _INT: Interrupts
                Local0 = FUIO (0x03)
                Switch (ToInteger (Local0))
                {
                    Case (Zero)
    ...
    Device (_SB.TPM)
    {
        ...
        Name (CREI, ResourceTemplate ()
        {
            ...
            GpioInt (Level, ActiveLow, ExclusiveAndWake, PullNone, 0x0000,
                "\\_SB.GPIO", 0x00, ResourceConsumer, _Y2D,
                )
                {   // Pin list
                    0x0000
                }
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            If ((AMDT == One))
            {
                CreateDWordField (CRST, \_SB.TPM._Y29._BAS, MTFB)  // _BAS: Base Address
                CreateDWordField (CRST, \_SB.TPM._Y29._LEN, LTFB)  // _LEN: Length
                MTFB = TPMB /* \TPMB */
                LTFB = TPBS /* \TPBS */
                CreateDWordField (CRST, \_SB.TPM._Y2A._BAS, MTFC)  // _BAS: Base Address
                CreateDWordField (CRST, \_SB.TPM._Y2A._LEN, LTFC)  // _LEN: Length
                MTFC = TPMC /* \TPMC */
                LTFC = TPCS /* \TPCS */
            ...
            Else
            {
                If ((DTPT == One))
                {
                    CreateDWordField (CRSD, \_SB.TPM._Y2B._BAS, MTFE)  // _BAS: Base Address
                    CreateDWordField (CRSD, \_SB.TPM._Y2B._LEN, LTFE)  // _LEN: Length
                    MTFE = 0xFED40000
                    LTFE = 0x5000
                ...
                ElseIf ((TTPF == One))
                {
                    ...
                    {
                        CreateDWordField (CRID, \_SB.TPM._Y2C._BAS, MTFD)  // _BAS: Base Address
                        CreateDWordField (CRID, \_SB.TPM._Y2C._LEN, LTFD)  // _LEN: Length
                        MTFD = 0xFED40000
                        LTFD = 0x5000
                    ...
                    Else
                    {
                        ...
                        CreateBitField (CREI, \_SB.TPM._Y2D._POL, LLVL)  // _POL: Polarity
                ...
                ElseIf ((TTPF == Zero))
                {
                    If ((AMDT == 0x02))
                    {
                        ...
                        {
                            CreateDWordField (CRSI, \_SB.TPM._Y2E._BAS, HSPB)  // _BAS: Base Address
                            CreateDWordField (CRSI, \_SB.TPM._Y2E._LEN, HSPL)  // _LEN: Length
                    ...
                    CreateDWordField (CRST, \_SB.TPM._Y2A._BAS, MTFF)  // _BAS: Base Address
                    MTFF = FTPM /* \FTPM */
                    Return (CRST) /* \_SB_.TPM_.CRST */
                }
        ...
        Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
        {
            If (((TMRQ != Zero) && (TMRQ != 0xFFFFFFFF)))
            {
                ...
                Else
                {
                    ...
                    CreateBitField (CREI, \_SB.TPM._Y2D._MOD, LTRG)  // _MOD: Mode
    ...
    Scope (_SB.PCI0.GPPA.PSP)
    {
        ...
        Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
        {
            CreateDWordField (CRS, \_SB.PCI0.GPPA.PSP._Y2F._BAS, PBAS)  // _BAS: Base Address
            CreateDWordField (CRS, \_SB.PCI0.GPPA.PSP._Y2F._LEN, PLEN)  // _LEN: Length
    ...
    Scope (\)
    {
        ...
        Scope (_SB.I2CB)
        {
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "1025174B")  // _HID: Hardware ID
                Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
                Name (_HRV, 0x8001)  // _HRV: Hardware Revision
                Name (_UID, One)  // _UID: Unique ID
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    If ((OSYS < 0x07DC))
                    {
                        Return (SBFI) /* \_SB_.I2CB.ECSH.SBFI */
                    }
        ...
        Scope (_SB.I2CD)
        {
            Device (TPAD)
            {
                ...
                CreateWordField (SBFB, \_SB.I2CD.TPAD._Y30._ADR, ADR0)  // _ADR: Address
                Method (_HID, 0, Serialized)  // _HID: Hardware ID
                {
                    If (~CondRefOf (TPDF))
                    {
    ...
    Scope (_SB.PCI0.SBRG)
    {
        ...
        Device (EC0)
        {
            ...
            Method (_Q20, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Local3 = TCLT /* \_SB_.PCI0.SBRG.EC0_.TCLT */
                Local4 = STML /* \_SB_.PCI0.SBRG.EC0_.STML */
                Local5 = PPPT /* \_SB_.PCI0.SBRG.EC0_.PPPT */
                DPTT (0x07, Local1)
                DPTT (0x06, Local2)
                DPTT (0x03, Local3)
                DPTT (0x2E, Local4)
            ...
            Method (_Q44, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                If ((DNLV == One))
                {
                    Notify (^^^GPP9.PEGP, 0xD1) // Hardware-Specific
                }
                ElseIf ((DNLV == 0x02))
                {
                    Notify (^^^GPP9.PEGP, 0xD2) // Hardware-Specific
                }
                ElseIf ((DNLV == 0x03))
                {
                    Notify (^^^GPP9.PEGP, 0xD3) // Hardware-Specific
                }
                ElseIf ((DNLV == 0x04))
                {
                    Notify (^^^GPP9.PEGP, 0xD4) // Hardware-Specific
                }
                ElseIf ((DNLV == 0x05))
                {
        ...
        Scope (EC0)
        {
            ...
            {
                Name (CMMA, Buffer (0x0F){})
                Arg0 [0x10] = BDNB /* \_SB_.PCI0.SBRG.EC0_.BDNB */
                Arg0 [0x11] = ToDecimalString (BSNW)
                CMMA = BDCB /* \_SB_.PCI0.SBRG.EC0_.BDCB */
                Arg0 [0x12] = CMMA /* \_SB_.PCI0.SBRG.EC0_.UB1I.CMMA */
                CMMA = BMNB /* \_SB_.PCI0.SBRG.EC0_.BMNB */
                Arg0 [0x13] = CMMA /* \_SB_.PCI0.SBRG.EC0_.UB1I.CMMA */
                Arg0 [0x08] = BCYC /* \_SB_.PCI0.SBRG.EC0_.BCYC */
            }

            Method (UB2I, 1, NotSerialized)
            {
                SBA2 (0x0B, 0x21)
                Arg0 [0x10] = SMD0 /* \_SB_.PCI0.SBRG.EC0_.SMD0 */
                Name (BFWB, Buffer (0x20){})
                CreateWordField (BFWB, Zero, DB2B)
                SBA2 (0x09, 0x1C)
                BFWB = SMD0 /* \_SB_.PCI0.SBRG.EC0_.SMD0 */
                Arg0 [0x11] = ToDecimalString (DB2B)
                SBA2 (0x0B, 0x22)
                Arg0 [0x12] = SMD0 /* \_SB_.PCI0.SBRG.EC0_.SMD0 */
                SBA2 (0x0B, 0x20)
                Arg0 [0x13] = SMD0 /* \_SB_.PCI0.SBRG.EC0_.SMD0 */
            }
        }
        ...
        Device (BAT1)
        {
            ...
            Method (BIFX, 1, NotSerialized)
            {
                ...
                If (ECOK ())
                {
                    BFFW = ^^EC0.ORRF /* \_SB_.PCI0.SBRG.EC0_.ORRF */
                    If ((^^EC0.BAM0 == Zero))
                    {
                        BASC = 0x0A
                    }

                    STAX [One] = ^^EC0.BAM0 /* \_SB_.PCI0.SBRG.EC0_.BAM0 */
                    Local0 = ^^EC0.BDC0 /* \_SB_.PCI0.SBRG.EC0_.BDC0 */
                    BMDL = Local0
                    STAX [0x02] = (^^EC0.BDC0 * BASC)
                    STAX [0x05] = ^^EC0.BDV0 /* \_SB_.PCI0.SBRG.EC0_.BDV0 */
                    If ((BFFW == One))
                    {
                        Local2 = ^^EC0.BFCB /* \_SB_.PCI0.SBRG.EC0_.BFCB */
                    }
                    Else
                    {
                        Local2 = ^^EC0.BFC0 /* \_SB_.PCI0.SBRG.EC0_.BFC0 */
                    }
                    ...
                    If ((Arg0 == One))
                    {
                        Return (STAX) /* \_SB_.PCI0.SBRG.BAT1.BIFX.STAX */
                    }
                    Else
                    {
                        Return (STAF) /* \_SB_.PCI0.SBRG.BAT1.BIFX.STAF */
                    }
                }
            }
            ...
            Method (_BST, 0, NotSerialized)  // _BST: Battery Status
            {
                ...
                If (ECOK ())
                {
                    PBST [Zero] = ^^EC0.BST0 /* \_SB_.PCI0.SBRG.EC0_.BST0 */
                    If ((^^EC0.BPC0 >> 0x0F))
                    {
                        Local4 = ((~^^EC0.BPC0 & 0xFFFF) + One)
                    }
                    Else
                    {
                        Local4 = ^^EC0.BPC0 /* \_SB_.PCI0.SBRG.EC0_.BPC0 */
                    }
                    ...
                    PBST [0x03] = ^^EC0.BPV0 /* \_SB_.PCI0.SBRG.EC0_.BPV0 */
                    If ((^^EC0.BDC0 != BMDL))
                    {
                        Notify (BAT1, 0x81) // Information Change
                    }
        ...
        Device (LID0)
        {
            ...
            {
                Local0 = ^^EC0.LIDF /* \_SB_.PCI0.SBRG.EC0_.LIDF */
                If (Local0)
                {
                    Return (Zero)
                }
    ...
    Device (_SB.PCI0.AMW0)
    {
        ...
        {
            /* 0000 */  0x6C, 0x0F, 0xBC, 0xAB, 0xA1, 0x8E, 0xD1, 0x11,  // l.......
            /* 0008 */  0x00, 0xA0, 0xC9, 0x06, 0x29, 0x10, 0x00, 0x00,  // ....)...
            /* 0010 */  0x41, 0x43, 0x01, 0x01, 0x6F, 0x0F, 0xBC, 0xAB,  // AC..o...
            /* 0018 */  0xA1, 0x8E, 0xD1, 0x11, 0x00, 0xA0, 0xC9, 0x06,  // ........
            /* 0020 */  0x29, 0x10, 0x00, 0x00, 0x42, 0x43, 0x01, 0x02,  // )...BC..
            /* 0028 */  0x75, 0x0F, 0xBC, 0xAB, 0xA1, 0x8E, 0xD1, 0x11,  // u.......
            /* 0030 */  0x00, 0xA0, 0xC9, 0x06, 0x29, 0x10, 0x00, 0x00,  // ....)...
            /* 0038 */  0x42, 0x44, 0x01, 0x02, 0x72, 0x0F, 0xBC, 0xAB,  // BD..r...
        ...
        Name (TFAN, Zero)
        Name (ECD2, Zero)
        Name (DEVS, Buffer (0x04)
        {
             0x55, 0xAA, 0xBB, 0xCC                           // U...
        })
        Name (TEST, Buffer (0x05)
        {
             0x55, 0x66, 0x77, 0x88, 0x99                     // Ufw..
        })
        Name (LCBT, Zero)
        Name (LMAT, 0x78)
        Name (LTGP, Zero)
        ...
        Method (ECPT, 2, NotSerialized)
        {
            Local1 = (Arg1 * 0x03E8)
            Local0 = Buffer (0x06){}
            Local0 [Zero] = 0x45
            Local0 [One] = (Arg0 + One)
            Local0 [0x02] = ((Local1 >> 0x08) & 0xFF)
            Local0 [0x03] = ((Local1 >> Zero) & 0xFF)
            ^^SBRG.EC0.ERCD (Local0)
            Local0 = Buffer (0x06){}
            Local0 [Zero] = 0x45
            Local0 [One] = Arg0
            Local0 [0x02] = ((Local1 >> 0x18) & 0xFF)
            Local0 [0x03] = ((Local1 >> 0x10) & 0xFF)
            ^^SBRG.EC0.ERCD (Local0)
        }

        Method (ECPL, 0, NotSerialized)
        {
            Local0 = Buffer (0x08){}
            Local0 [Zero] = 0x45
            Local0 [One] = 0x4D
            Local0 = ^^SBRG.EC0.ERCD (Local0)
            Local1 = (DerefOf (Local0 [Zero]) & 0x0F)
            Return (Local1)
        }
        ...
        {
            XCMI = Arg0
            Return (XCMD) /* \_SB_.PCI0.AMW0.XCMD */
        }
        ...
        Method (WCAC, 1, NotSerialized)
        {
            If ((Arg0 == Zero))
            {
                If ((CCAC == Zero))
                {
                    ...
                    Debug = FOO /* \_SB_.PCI0.AMW0.WCAC.FOO_ */
            ...
            ElseIf ((CCAC != Zero))
            {
                ...
                Debug = FOO1 /* \_SB_.PCI0.AMW0.WCAC.FOO1 */
        ...
        Method (WQAC, 1, NotSerialized)
        {
            If ((CCAC == Zero))
            {
                ...
                Debug = FOO /* \_SB_.PCI0.AMW0.WQAC.FOO_ */
        ...
        Method (WSAC, 2, NotSerialized)
        {
            If ((CCAC == Zero))
            {
                ...
                Debug = FOO /* \_SB_.PCI0.AMW0.WSAC.FOO_ */
        ...
        Method (WMBD, 3, Serialized)
        {
            Switch (Arg1)
            {
                ...
                {
                    ^^SBRG.EC0.PL3E = Arg2
                    Return (^^SBRG.EC0.PL3E) /* \_SB_.PCI0.SBRG.EC0_.PL3E */
                }
                Case (0xF6)
                {
                    ^^SBRG.EC0.KBLL = Arg2
                    Return (^^SBRG.EC0.KBLL) /* \_SB_.PCI0.SBRG.EC0_.KBLL */
                }
                Case (0xC7)
                {
                    ^^SBRG.EC0.MUTE = Arg2
                ...
                {
                    ^^SBRG.EC0.PSON = Arg2
                    Return (^^SBRG.EC0.PSON) /* \_SB_.PCI0.SBRG.EC0_.PSON */
                }
                Case (0x7D)
                {
                    ^^SBRG.EC0.TFAN = Arg2
                ...
                Case (0x71)
                {
                    ^^SBRG.EC0.GFAN = Zero
                    ^^SBRG.EC0.FANB = Arg2
                    Return (^^SBRG.EC0.FANB) /* \_SB_.PCI0.SBRG.EC0_.FANB */
                }
                Case (0x70)
                {
                    ^^SBRG.EC0.TFAN = Zero
                    ...
                    ^^SBRG.EC0.FAN1 = Arg2
                    ^^SBRG.EC0.FAN2 = Arg2
                    Return (^^SBRG.EC0.FAN1) /* \_SB_.PCI0.SBRG.EC0_.FAN1 */
                }
                Case (0x57)
                {
                    ^^SBRG.EC0.GFAN = Zero
                    ^^SBRG.EC0.CRAF = Arg2
                    Return (^^SBRG.EC0.CRAF) /* \_SB_.PCI0.SBRG.EC0_.CRAF */
                }
                Case (0xC4)
                {
                    ^^SBRG.EC0.LCDO = Arg2
                    Return (^^SBRG.EC0.LCDO) /* \_SB_.PCI0.SBRG.EC0_.LCDO */
                }
                Case (0x6A)
                {
                    ^^SBRG.EC0.ADJF = Arg2
                    Return (^^SBRG.EC0.ADJF) /* \_SB_.PCI0.SBRG.EC0_.ADJF */
                }
                Case (0x6B)
                {
                    ^^SBRG.EC0.FAN1 = Arg2
                ...
                {
                    ^^SBRG.EC0.XFNW = Arg2
                    Return (^^SBRG.EC0.XFNW) /* \_SB_.PCI0.SBRG.EC0_.XFNW */
                }
                Case (0x67)
                {
                    ^^SBRG.EC0.TENF = Arg2
                    Return (^^SBRG.EC0.TENF) /* \_SB_.PCI0.SBRG.EC0_.TENF */
                }
                Case (0x66)
                {
                    ^^SBRG.EC0.FLVL = Arg2
                    Return (^^SBRG.EC0.FLVL) /* \_SB_.PCI0.SBRG.EC0_.FLVL */
                }
                Case (0x64)
                {
                    ^^SBRG.EC0.BCPS = Arg2
                    Return (^^SBRG.EC0.BCPS) /* \_SB_.PCI0.SBRG.EC0_.BCPS */
                }
                Case (0x65)
                {
                    ^^SBRG.EC0.BCPC = Arg2
                    Return (^^SBRG.EC0.BCPC) /* \_SB_.PCI0.SBRG.EC0_.BCPC */
                }
                Case (0xED)
                {
                    ...
                    If ((Local1 == One))
                    {
                        ...
                        LMAT = ^^^NPCF.AMAT /* External reference */
                        LCBT = ^^^NPCF.ACBT /* External reference */
                        Notify (NPCF, 0xC0) // Hardware-Specific
                    }
                ...
                Case (0xF1)
                {
                    ...
                    ECPT (0x30, (Local0 / 0x03E8))
                }
                Case (0xF2)
                {
                    Local0 = ToInteger (Arg2)
                    ECPT (0x32, (Local0 / 0x03E8))
                }
                Case (0xF3)
                {
                    Local0 = ToInteger (Arg2)
                    ECPT (0x34, (Local0 / 0x03E8))
                }
                Case (0xE7)
                {
                    Local0 = ToInteger (Arg2)
                    If ((Local0 == Zero))
                    {
                        ...
                        Notify (NPCF, 0xC0) // Hardware-Specific
                        ^^SBRG.EC0.PPAB = Zero
                        Return (^^SBRG.EC0.PPAB) /* \_SB_.PCI0.SBRG.EC0_.PPAB */
                    }
                    ...
                    If ((Local0 == One))
                    {
                        ^^^NPCF.DBAC = Zero
                        ^^^NPCF.DBDC = Zero
                        ^^^NPCF.AMAT = LMAT /* \_SB_.PCI0.AMW0.LMAT */
                        Notify (NPCF, 0xC0) // Hardware-Specific
                        ^^SBRG.EC0.PPAB = One
                        Return (^^SBRG.EC0.PPAB) /* \_SB_.PCI0.SBRG.EC0_.PPAB */
                    }
                ...
                Case (0x51)
                {
                    If ((DPMF != 0x02))
                    {
                        ...
                        If ((Local0 == One))
                        {
                            Debug = "<<< Opt-mode 2 Enable >>>"
                            ^^^NPCF.ACBT = LCBT /* \_SB_.PCI0.AMW0.LCBT */
                            Notify (NPCF, 0xC0) // Hardware-Specific
                        }
                ...
                {
                    ^^SBRG.EC0.FDTY = Arg2
                    Return (^^SBRG.EC0.FDTY) /* \_SB_.PCI0.SBRG.EC0_.FDTY */
                }
                Case (0x46)
                {
                    ^^SBRG.EC0.FDTY = Arg2
                ...
                Case (0x47)
                {
                    ^^SBRG.EC0.GDTY = Arg2
                    ^^SBRG.EC0.FAN2 = Arg2
                    Return (^^SBRG.EC0.GDTY) /* \_SB_.PCI0.SBRG.EC0_.GDTY */
                }
                Case (0x63)
                {
                    WXCM (0xD2, DerefOf (Arg2 [Zero]))
                    WXCM (0xD3, DerefOf (Arg2 [One]))
                    WXCM (0xD4, DerefOf (Arg2 [0x02]))
                    WXCM (0xD5, DerefOf (Arg2 [0x03]))
                    WXCM (0xD6, DerefOf (Arg2 [0x04]))
                }
                Case (0x61)
                {
                    Return (^^SBRG.EC0.BHEA) /* \_SB_.PCI0.SBRG.EC0_.BHEA */
                }
                Case (0xA3)
                {
                    WXCM (0xD1, Arg2)
        ...
        Method (WMBC, 3, Serialized)
        {
            ...
            Else
            {
                Switch (Arg1)
                {
                    ...
                    Case (0xE7)
                    {
                        Return (^^^NPCF.DBAC) /* External reference */
                    }
                    Case (0xCA)
                    {
                        Return (^^SBRG.EC0.PSON) /* \_SB_.PCI0.SBRG.EC0_.PSON */
                    ...
                    Case (0xC7)
                    {
                        Return (^^SBRG.EC0.MUTE) /* \_SB_.PCI0.SBRG.EC0_.MUTE */
                    }
                    Case (0xEF)
                    {
                        Return (~^^SBRG.EC0.LIDF)
                    }
                    Case (0x7D)
                    {
                        Return (^^SBRG.EC0.TFAN) /* \_SB_.PCI0.SBRG.EC0_.TFAN */
                    }
                    Case (0xE1)
                    {
                        Return (^^SBRG.EC0.CTMP) /* \_SB_.PCI0.SBRG.EC0_.CTMP */
                    }
                    Case (0xE2)
                    {
                        Return (^^SBRG.EC0.SKTC) /* \_SB_.PCI0.SBRG.EC0_.SKTC */
                    }
                    Case (0xE3)
                    {
                        Return (^^SBRG.EC0.SKTC) /* \_SB_.PCI0.SBRG.EC0_.SKTC */
                    ...
                    Case (0xE4)
                    {
                        Return (^^SBRG.EC0.RPM1) /* \_SB_.PCI0.SBRG.EC0_.RPM1 */
                    }
                    Case (0xE5)
                    {
                        Return (^^SBRG.EC0.RPM2) /* \_SB_.PCI0.SBRG.EC0_.RPM2 */
                    }
                    Case (0x71)
                    {
                        Return (^^SBRG.EC0.FANB) /* \_SB_.PCI0.SBRG.EC0_.FANB */
                    ...
                    Case (0x68)
                    {
                        ^^SBRG.EC0.XFNR = Arg2
                        Sleep (0x64)
                        Return (^^SBRG.EC0.XFN1) /* \_SB_.PCI0.SBRG.EC0_.XFN1 */
                    }
                    Case (0x67)
                    {
                        Return (^^SBRG.EC0.TENF) /* \_SB_.PCI0.SBRG.EC0_.TENF */
                    ...
                    Case (0x63)
                    {
                        ...
                        TEST [0x03] = RXCM (0xD5)
                        TEST [0x04] = RXCM (0xD6)
                        Return (TEST) /* \_SB_.PCI0.AMW0.TEST */
                    }
                    Case (0x50)
                    {
                        Return (^^SBRG.EC0.FDTY) /* \_SB_.PCI0.SBRG.EC0_.FDTY */
                    ...
                    Case (0xD9)
                    {
                        Return (^^SBRG.EC0.KBAT) /* \_SB_.PCI0.SBRG.EC0_.KBAT */
                    }
                    Case (0xEB)
                    {
                        Return (One)
                    ...
                    Case (0xC9)
                    {
                        Return (^^SBRG.EC0.FNKS) /* \_SB_.PCI0.SBRG.EC0_.FNKS */
                    }
                    Case (0x87)
                    {
                        If (^^SBRG.EC0.PLED)
        ...
        Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event, xx=0x00-0xFF
        {
            If ((Arg0 == 0xD2))
            {
                Return (DEVS) /* \_SB_.PCI0.AMW0.DEVS */
            }
    ...
    Scope (_SB)
    {
        Device (GAPD)
        {
            Name (_HID, EisaId ("GBT0005"))  // _HID: Hardware ID
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((^^PCI0.AMW0.RXCM (0xC7) == One))
                {
                    ^^PCI0.GPP9.PG00._OFF ()
                    ^^PCI0.GPP9.WMOF = One
                }

                ^^PCI0.SBRG.EC0.OSTM = MMIN /* \_SB_.MMIN */
                ^^PCI0.SBRG.EC0.OSTH = MHUR /* \_SB_.MHUR */
                ^^PCI0.SBRG.EC0.OSTE = One
                Return (Zero)
            }
        }
    }
    ...
    Method (OPTS, 1, Serialized)
    {
        If (Arg0)
        {
            ...
            \_SB.PCI0.SBRG.LID0.PLID = \_SB.PCI0.SBRG.EC0.LIDF
        }
        ...
        If ((Arg0 == 0x04))
        {
            If ((WLST == 0x02))
            {
                WLST = \_SB.PCI0.SBRG.EC0.LWAK
            }

            If ((WLST == One))
            {
                If ((\_SB.PCI0.SBRG.EC0.ADPT == Zero))
                {
                    \_SB.PCI0.SBRG.EC0.LWAK = Zero
                }

                If ((\_SB.PCI0.SBRG.EC0.ADPT == One))
                {
                    \_SB.PCI0.SBRG.EC0.LWAK = One
                }
            }
    ...
    Method (OWAK, 1, Serialized)
    {
        ...
        If (((Arg0 == 0x03) || (Arg0 == 0x04)))
        {
            If ((\_SB.PCI0.SBRG.EC0.LIDF != \_SB.PCI0.SBRG.LID0.PLID))
            {
                Notify (\_SB.PCI0.SBRG.LID0, 0x80) // Status Change
            }
        }
    }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (UPWD, 1, Serialized)
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPPX.UPWD\n", Zero, Zero, Zero, Zero, Zero, Zero)
            M232 (0x5B, Arg0, Zero)
        }
    }
}
